...
**Current Version:** 2.0.0 — last updated 2026-05-03 (Story 9-2 done after iter-1 + iter-2 code review; gateway status dashboard shipped on top of the Story 9-1 web server, with mobile-first responsive HTML/CSS/JS).
