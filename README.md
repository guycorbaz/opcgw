...
**Current Version:** 2.0.0 — last updated 2026-05-03 (Story 9-3 implementation complete; live metric values page at /metrics.html with per-row staleness badges, GET /api/devices JSON contract, ApplicationSummary extended to carry per-device topology).
