...
|--------------------|-----------|--------------------------------------------------------------------|
| `<major>.<minor>.<patch>` | `2.4.0`  | The exact release. Pin to this for fully reproducible deployments. |
| `<major>.<minor>`         | `2.4`    | Latest patch within a minor line. Auto-updates on patch releases.  |
...
| `manifest unknown` on `gcorbaz/opcgw:2.0.0` | No image was ever published for v2.0.0 (workflow bug; see the "Supported tags" note above) | Pull `:2.4` (recommended) or `:2.4.0` (exact) instead |
