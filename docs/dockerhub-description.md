...
|--------------------|-----------|--------------------------------------------------------------------|
| `<major>.<minor>.<patch>` | `2.3.0`  | The exact release. Pin to this for fully reproducible deployments. |
...
| `manifest unknown` on `gcorbaz/opcgw:2.0.0` | No image was ever published for v2.0.0 (workflow bug; see the "Supported tags" note above) | Pull `:2.3` (recommended) or `:2.3.0` (exact) instead |
